        ...
        <div className='mb-60'>
          {
            selectPlayer.map((selectPlayer, idx) => {
                ...
                return <div  key={idx}>
                    ...
                    <img className='w-24 h-20 object-cover rounded-lg' src={image} alt="player-photo" />
                    <div>
                    <h1 className='text-lg font-semibold'>{name}</h1>
                    <p>{role}</p>
                    <p className='text-[#131313] text-opacity-60'>${biddingPrice}</p>
                    </div>
                    </div>
                    <div>
                      <button onClick={() => {
                          ...
                          <img width="30" height="30" src="https://img.icons8.com/fluency-systems-regular/50/filled-trash.png" alt="filled-trash"/>
                          </button>
                    </div>
